// Based on https://github.com/biomejs/biome/blob/503e8ef886e75b6091e9af190cd245cec05ea44e/scripts/version-check.ts
...
async function getCommit(sha: string): Promise<CommitResponse> {
	const url = `https://api.github.com/repos/portone-io/browser-sdk-generator/commits/${sha}`;
